...
@section('page_level_css')
    <link href="/assets/pages/css/portfolio-edit.css" rel="stylesheet" type="text/css" />
@endsection
...
@section('page_level_js')
    <script src="/assets/pages/scripts/portfolio-edit.js" type="text/javascript"></script>
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <form id="form_portfolio_edit" action="/portfolio/save" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-md-4">
