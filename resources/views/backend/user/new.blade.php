...
<script src="{{ url('/') }}/assets/pages/scripts/user-new.js" type="text/javascript"></script>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{{ url('admin_1lkh6x/user/save') }}" id="form_user_new" method="post" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-body">
